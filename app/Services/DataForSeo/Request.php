...
use App\Services\DataForSeo\Requests\GoogleAdsKeywordsForKeywords;
...
class Request
{
    ...
    public const TYPE_GOOGLE_ADS_KEYWORDS_FOR_KEYWORDS = 'google-ads-keywords-for-keywords';
    ...
    public function fetch(): self
    {
        $request = match ($this->requestType) {
            ...
            self::TYPE_GOOGLE_ADS_KEYWORDS_FOR_KEYWORDS => new GoogleAdsKeywordsForKeywords(),
        };
