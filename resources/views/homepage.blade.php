    ...
    <div class="bg-gray-50 border-t border-gray-200 px-6 sm:px-8 xl:px-20 rounded-lg -mb-14">
        <div class="max-w-screen-xl mx-auto pt-16 pb-32">
            <div class="lg:w-[75%] mx-auto flex sm:flex-nowrap items-end gap-5 md:gap-6">
                ...
                <div class="grow-0">
                    <button class="btn btn-lg no-animation gap-2 tracking-widest bg-gray-900 h-[62px] min-h-[62px] group sm:px-4 md:px-7">
                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" class="w-6 h-6 group-hover:scale-110 transition-all">
