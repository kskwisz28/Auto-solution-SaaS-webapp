            ...
            <div class="col-span-2">
                ...
                <x-card class="px-0 lg:px-8 border border-zinc-100">
                    <div class="grid grid-cols-3 gap-3">
                        <button class="btn btn-ghost btn-block normal-case bg-zinc-200 hover:bg-primary leading-5 h-16 text-zinc-700 hover:text-zinc-100">FAQ Performance</button>
                        <button class="btn btn-ghost btn-block normal-case bg-zinc-200 hover:bg-primary leading-5 h-16 text-zinc-700 hover:text-zinc-100">FAQ Tracking</button>
                        <button class="btn btn-ghost btn-block normal-case bg-zinc-200 hover:bg-primary leading-5 h-16 text-zinc-700 hover:text-zinc-100">FAQ Billing</button>
                        <button class="btn btn-ghost btn-block normal-case bg-zinc-200 hover:bg-primary leading-5 h-16 text-zinc-700 hover:text-zinc-100">Getting started with your first campaign</button>
                        <button class="btn btn-ghost btn-block normal-case bg-zinc-200 hover:bg-primary leading-5 h-16 text-zinc-700 hover:text-zinc-100">FAQ API</button>
                        <button class="btn btn-ghost btn-block normal-case bg-zinc-200 hover:bg-primary leading-5 h-16 text-zinc-700 hover:text-zinc-100">FAQ Agencies</button>
                    </div>
                </x-card>
            </div>

            <div class="col-span-1">
                <x-card class="px-0 py-3 lg:px-5 border border-zinc-100">
                    <div class="flex gap-7 place-items-center">
                        <svg xmlns="http://www.w3.org/2000/svg" width="40" height="40" viewBox="0 0 20 20" class="text-primary">
