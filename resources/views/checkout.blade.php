<x-main-layout>
    ...
    <x-container>
        <div class="flex flex-col max-w-4xl mx-auto">
            ...
            <a href="#" class="mx-auto flex flex-nowrap items-center max-w-[220px] my-10 pl-3 pr-5 py-6 lg:py-6 text-lg md:text-base xl:text-xl font-semibold text-white tracking-wider uppercase
            select-none transition duration-500 ease-in-out transform bg-green-600 rounded-2xl shadow-lg shadow-zinc-300 border border-green-700/50 hover:shadow-green-500/50">
                ...
                <svg width="24" height="24" viewBox="0 0 576 512" class="w-6 h-6 ml-3">
                ...
                <span class="divider divider-horizontal mx-3"></span>
            ...
            <img src="/img/payment_trust.jpg" class="max-w-xl mx-auto my-10"/>
        </div>
    </x-container>
</x-main-layout>
