...
<x-main-layout>
    ...
    <section class="max-w-screen-lg mx-auto mb-16 space-y-12">
        <div class="py-10 mx-auto">
            <div class="grid grid-cols-2 gap-8">
                <img src="/img/illustrations/increase.svg" class="m-8"/>

                <div class="card overflow-visible bg-base-100 shadow-lg rounded-xl px-12 py-8">
            ...
            <div class="grid grid-cols-2 gap-8 mt-12">
                ...
                <img src="/img/illustrations/deal.svg" class="m-6"/>
            </div>
