        ...
        <OnClickOutside @trigger="close" class="relative">
            ...
            <ul v-if="suggestionsOpened"
                ...
                <li v-for="(item, index) in suggestions.items"
                    ...
                    :class="{
                        'hover:bg-zinc-100': index !== suggestions.index,
                    ...
                    <svg class="w-5 h-5 mr-4"
                         :class="{
                            'group-hover:text-zinc-900': index !== suggestions.index,
...
export default {
    ...
    methods: {
        ...
        isSelected(item, index) {
            return index !== this.suggestions.index && item.mail_domain === this.domain;
        },
