                    ...
                    <tr v-if="rankingItems.items.length === 0" class="no-hover">
                        <td colspan="9" class="text-center !py-12">
                            <div class="text-zinc-600 text-lg mb-5 flex flex-col items-center">
                                ...
                                <div>
                                    There are no keywords for this domain for which AutoRanker can work. Did you enter the correct domain name and the right market? You can change your domain and market <button @click="openModal('query-switcher-modal')" class="text-primary hover:underline">here</button>.
                                </div>
                            </div>
                        </td>
                    </tr>
