<template>
    <div @click="click"
         ...
         class="group flex flex-nowrap items-center mt-6 md:mt-0 pl-5 pr-5 py-8 lg:py-5 xl:py-5 text-lg md:text-base xl:text-md font-semibold text-white tracking-wider uppercase
