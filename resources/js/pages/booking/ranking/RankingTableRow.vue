    ...
    <tr :class="{selected: item.selected}">
        <td class="whitespace-normal break-words min-w-[180px] font-medium white">
            ...
            <span class="whitespace-nowrap">
                ...
                <svg @click="openPreviewRank(item.keyword)" xmlns="http://www.w3.org/2000/svg" fill="currentColor" class="w-4 h-4 inline-block cursor-pointer mx-0.5 text-zinc-400 hover:text-primary transition duration-300" viewBox="0 0 24 24">
