<template>
    <div @click="submit"
         ...
         class="mx-auto flex flex-nowrap items-center w-full md:w-[220px] my-10 pl-3 pr-5 py-5 lg:py-6 text-lg md:text-base xl:text-xl font-semibold text-white tracking-wider uppercase
        ...
        <span class="divider divider-horizontal mx-3 hidden md:flex"></span>

        <div class="flex-1 text-center tracking-widest md:tracking-wide">Submit</div>
    </div>
</template>
