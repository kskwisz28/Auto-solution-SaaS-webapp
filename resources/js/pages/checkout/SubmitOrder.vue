<template>
    <div @click="submit"
         ...
         class="mx-auto flex flex-nowrap items-center w-[220px] my-10 pl-3 pr-5 py-6 lg:py-6 text-lg md:text-base xl:text-xl font-semibold text-white tracking-wider uppercase
