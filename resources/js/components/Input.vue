<template>
    <div class="flex flex-col flex-nowrap w-full" :class="containerClass">
        <input :type="type"
               class="input w-full text-md ring-1 ring-gray-300 px-4 py-1 text-base appearance-none hover:ring-2 hover:ring-accent/50 focus:ring-2 focus:ring-accent/50 focus:outline-none"
