    ...
    <div class="w-24 md:28">
        <Listbox v-model="selectedItem">
            <div class="relative mt-1">
                ...
                <ListboxButton class="relative w-full cursor-pointer rounded-lg bg-white mt-1 py-4 pl-5 pr-10 text-left ring-1 ring-gray-300 hover:ring-2 hover:ring-primary/50 sm:text-sm transition-all">
