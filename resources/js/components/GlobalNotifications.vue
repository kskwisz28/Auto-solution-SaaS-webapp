<template>
    <transition name="fade">
        <div v-if="opened" class="fixed top-4 left-1/2 -translate-x-1/2 z-50 alert shadow-lg max-w-xl" :class="[!type ? 'bg-white' : `alert-${type}`]">
            <div>
...
.fade-leave-active {
    animation: fade-in ease-in .1s reverse;
}
@keyframes fade-in {
    0% {
        opacity: 0;
